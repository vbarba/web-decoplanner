...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'tipf.gasSwitchStop': "Hold time when switching to a deco gas. Set 0 for no switch stop.",
      'tipf.surfaceDesat': "Surface-interval desaturation factor (Bühlmann pulmonary shunt) for repetitive dives. 1.00 = standard symmetric ZH-L16 (= Subsurface); 0.75 slows off-gassing to match DecoPlanner. Only affects dives after a surface interval.",
      'tipf.surfaceInterval': "Surface interval before this dive — minutes breathing air at the surface since the previous dive. Residual tissue load is carried into this plan.",
      ...
      'field.gasSwitchStop': 'GAS SWITCH STOP',
      'field.surfaceDesat': 'SI DESAT ×',
      'field.inclTravel': 'LEVEL TIME INCLUDES TRAVEL',

      // Repetitive dives
      'dive.tab': 'DIVE',
      'dive.add': 'Add a repetitive dive',
      'dive.remove': 'Remove this dive',
      'field.surfaceInterval': 'SURFACE INTERVAL',
    ...
    es: {
      ...
      'tipf.gasSwitchStop': "Tiempo de parada al cambiar a un gas de deco. Pon 0 para no detenerse.",
      'tipf.surfaceDesat': "Factor de desaturación en superficie (shunt pulmonar de Bühlmann) para buceos sucesivos. 1,00 = ZH-L16 simétrico estándar (= Subsurface); 0,75 ralentiza la desgasificación para igualar a DecoPlanner. Solo afecta a buceos tras un intervalo en superficie.",
      'tipf.surfaceInterval': "Intervalo en superficie antes de este buceo — minutos respirando aire en superficie desde el buceo anterior. La carga residual de los tejidos se arrastra a este plan.",
      ...
      'field.ppo2deco': 'ppO₂ DECO',
      'field.gasSwitchStop': 'PARADA CAMBIO DE GAS',
      'field.surfaceDesat': 'DESAT. SUP. ×',
      'dive.tab': 'BUCEO',
      'dive.add': 'Añadir un buceo sucesivo',
      'dive.remove': 'Eliminar este buceo',
      'field.surfaceInterval': 'INTERVALO SUPERFICIE',
    ...
    fr: {
      ...
      'tipf.gasSwitchStop': "Durée d’arrêt lors du passage à un gaz déco. Mettez 0 pour ne pas s’arrêter.",
      'tipf.surfaceDesat': "Facteur de désaturation en surface (shunt pulmonaire de Bühlmann) pour les plongées successives. 1,00 = ZH-L16 symétrique standard (= Subsurface) ; 0,75 ralentit le dégazage pour correspondre à DecoPlanner. N’affecte que les plongées après un intervalle de surface.",
      'tipf.surfaceInterval': "Intervalle de surface avant cette plongée — minutes passées à respirer de l’air en surface depuis la plongée précédente. La charge tissulaire résiduelle est reportée dans ce plan.",
      ...
      'field.gasSwitchStop': 'ARRÊT CHANGEMENT GAZ',
      'field.surfaceDesat': 'DÉSAT. SURF. ×',
      'dive.tab': 'PLONGÉE',
      'dive.add': 'Ajouter une plongée successive',
      'dive.remove': 'Supprimer cette plongée',
      'field.surfaceInterval': 'INTERVALLE SURFACE',
    ...
    de: {
      ...
      'tipf.gasSwitchStop': "Haltezeit beim Wechsel auf ein Dekogas. 0 = kein Wechselstopp.",
      'tipf.surfaceDesat': "Entsättigungsfaktor an der Oberfläche (Bühlmann-Lungenshunt) für Wiederholungstauchgänge. 1,00 = symmetrisches Standard-ZH-L16 (= Subsurface); 0,75 verlangsamt die Entsättigung wie DecoPlanner. Betrifft nur Tauchgänge nach einer Oberflächenpause.",
      'tipf.surfaceInterval': "Oberflächenpause vor diesem Tauchgang — Minuten Luftatmung an der Oberfläche seit dem vorherigen Tauchgang. Die Restsättigung der Gewebe wird in diesen Plan übernommen.",
      ...
      'field.gasSwitchStop': 'GASWECHSEL-STOPP',
      'field.surfaceDesat': 'OF-ENTSÄTT. ×',
      'dive.tab': 'TAUCHGANG',
      'dive.add': 'Wiederholungstauchgang hinzufügen',
      'dive.remove': 'Diesen Tauchgang entfernen',
      'field.surfaceInterval': 'OBERFLÄCHENPAUSE',
    ...
    zh: {
      ...
      'tipf.gasSwitchStop': "切换到减压气体时的停留时间。设为 0 表示不停留。",
      'tipf.surfaceDesat': "水面间隔脱饱和系数（Bühlmann 肺分流）用于重复潜水。1.00 = 标准对称 ZH-L16（= Subsurface）；0.75 减慢脱气以匹配 DecoPlanner。仅影响水面间隔之后的潜水。",
      'tipf.surfaceInterval': "本次潜水前的水面间隔——自上次潜水以来在水面呼吸空气的分钟数。上次潜水的组织残余负荷将带入本计划。",
      ...
      'field.gasSwitchStop': '气体切换停留',
      'field.surfaceDesat': '水面脱饱和 ×',
      'dive.tab': '潜水',
      'dive.add': '添加重复潜水',
      'dive.remove': '删除此潜水',
      'field.surfaceInterval': '水面间隔',
