...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'tip.summary': 'Summarized stop ladder with contingency rows: the plan plus ±3 m deeper/shallower and ±1 min longer/shorter.',
      ...
      'sum.variant': 'DIVE',
      'sum.shortStops': 'SHORT STOPS',
      'sum.longStop': 'LONG STOP',
      'sum.deco': 'DECO',
      'sum.runtime': 'RUNTIME',
      'sum.planned': 'PLANNED',
      'sum.none': 'no stops',
      'sum.legend': 'Short stops grouped; the longest single stop is the “long stop”. Contingency rows re-plan ±3 m / ±1 min around the planned dive.',
    ...
    es: {
      ...
      'tip.summary': 'Escalera de paradas resumida con filas de contingencia: el plan más ±3 m más profundo/somero y ±1 min más largo/corto.',
      ...
      'sum.variant': 'INMERSIÓN',
      'sum.shortStops': 'PARADAS CORTAS',
      'sum.longStop': 'PARADA LARGA',
      'sum.deco': 'DECO',
      'sum.runtime': 'TIEMPO TOTAL',
      'sum.planned': 'PLANIFICADA',
      'sum.none': 'sin paradas',
      'sum.legend': 'Paradas cortas agrupadas; la parada individual más larga es la “parada larga”. Las filas de contingencia recalculan ±3 m / ±1 min en torno a la inmersión planificada.',
    ...
    fr: {
      ...
      'tip.summary': 'Échelle de paliers résumée avec lignes de contingence : le plan plus ±3 m plus profond/moins profond et ±1 min plus long/plus court.',
      ...
      'sum.variant': 'PLONGÉE',
      'sum.shortStops': 'PALIERS COURTS',
      'sum.longStop': 'PALIER LONG',
      'sum.deco': 'DÉCO',
      'sum.runtime': 'TEMPS TOTAL',
      'sum.planned': 'PLANIFIÉE',
      'sum.none': 'aucun palier',
      'sum.legend': 'Paliers courts regroupés ; le palier le plus long est le « palier long ». Les lignes de contingence recalculent ±3 m / ±1 min autour de la plongée planifiée.',
    ...
    de: {
      ...
      'tip.summary': 'Zusammengefasste Stopp-Leiter mit Kontingenzzeilen: der Plan plus ±3 m tiefer/flacher und ±1 min länger/kürzer.',
      ...
      'sum.variant': 'TAUCHGANG',
      'sum.shortStops': 'KURZE STOPPS',
      'sum.longStop': 'LANGER STOPP',
      'sum.deco': 'DEKO',
      'sum.runtime': 'GESAMTZEIT',
      'sum.planned': 'GEPLANT',
      'sum.none': 'keine Stopps',
      'sum.legend': 'Kurze Stopps gruppiert; der längste Einzelstopp ist der „lange Stopp“. Kontingenzzeilen rechnen ±3 m / ±1 min um den geplanten Tauchgang neu.',
    ...
    zh: {
      ...
      'tip.summary': '汇总的停留阶梯及应急行：计划本身，加上 ±3 m 更深/更浅以及 ±1 min 更长/更短。',
      ...
      'sum.planned': '计划',
      'sum.none': '无停留',
      'sum.legend': '短停留合并显示；时间最长的单次停留为“长停留”。应急行围绕计划潜水重新计算 ±3 m / ±1 min。',
