...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'tipf.rounding': "How each stop's time rounds to whole minutes. CEIL (recommended) always rounds up — conservative. NEAREST rounds to the closest minute (matches DecoPlanner / V-Planner), trimming 0–2 min of total deco.",
      ...
      'field.rounding': 'STOP ROUNDING',
      'field.roundCeil': 'CEIL',
      'field.roundNearest': 'NEAREST',
      'field.water': 'WATER',
      'field.salt': 'SALT',
      'field.fresh': 'FRESH',
    ...
    es: {
      ...
      'tipf.rounding': "Cómo se redondea a minutos enteros el tiempo de cada parada. CEIL (recomendado) siempre redondea hacia arriba: conservador. NEAREST redondea al minuto más cercano (igual que DecoPlanner / V-Planner), recortando 0–2 min de deco total.",
      ...
      'field.rounding': 'REDONDEO',
      'field.roundCeil': 'CEIL',
      'field.roundNearest': 'CERCANO',
      'field.water': 'AGUA',
      'field.salt': 'SALADA',
      'field.fresh': 'DULCE',
    ...
    fr: {
      ...
      'tipf.rounding': "Arrondi du temps de chaque palier à la minute entière. CEIL (recommandé) arrondit toujours vers le haut — conservateur. NEAREST arrondit à la minute la plus proche (comme DecoPlanner / V-Planner), retirant 0–2 min de déco totale.",
      ...
      'field.rounding': 'ARRONDI',
      'field.roundCeil': 'CEIL',
      'field.roundNearest': 'PROCHE',
      'field.water': 'EAU',
      'field.salt': 'SALÉE',
      'field.fresh': 'DOUCE',
      'field.surface': 'SURFACE',
    ...
    de: {
      ...
      'tipf.rounding': "Wie die Zeit jedes Stopps auf ganze Minuten gerundet wird. CEIL (empfohlen) rundet immer auf – konservativ. NEAREST rundet auf die nächste Minute (wie DecoPlanner / V-Planner) und kürzt 0–2 min der gesamten Dekozeit.",
      ...
      'field.rounding': 'RUNDUNG',
      'field.roundCeil': 'CEIL',
      'field.roundNearest': 'NÄCHSTE',
      'field.water': 'WASSER',
      'field.salt': 'SALZ',
      'field.fresh': 'SÜSS',
    ...
    zh: {
      ...
      'tipf.rounding': "每个停留的时间如何取整到整分钟。CEIL（推荐）始终向上取整——更保守。NEAREST 取最接近的整分钟（与 DecoPlanner / V-Planner 一致），可减少总减压时间 0–2 分钟。",
